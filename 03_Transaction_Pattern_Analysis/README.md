...
- **What makes it stand out:** the write-up doesn't just report scores — it explains *why* they came out the way they did, including calling out where results should be read with caution. See **["What Sets This Apart"](#-7-what-sets-this-apart)** below.
...
## 🧩 4. Stage 1: Clustering (Unsupervised)
...
## 🌲 5. Stage 2: Classification (Supervised)
